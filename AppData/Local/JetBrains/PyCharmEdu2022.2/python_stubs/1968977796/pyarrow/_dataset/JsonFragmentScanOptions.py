...
class JsonFragmentScanOptions(FragmentScanOptions):
    """
    JsonFragmentScanOptions(ParseOptions parse_options=None, ReadOptions read_options=None)
    ...
    """
    def equals(self, JsonFragmentScanOptions_other): # real signature unknown; restored from __doc__
        """
        JsonFragmentScanOptions.equals(self, JsonFragmentScanOptions other)
    ...
    def __init__(self, ParseOptions_parse_options=None, ReadOptions_read_options=None): # real signature unknown; restored from __doc__
        pass
    ...
    def __reduce__(self): # real signature unknown; restored from __doc__
        """ JsonFragmentScanOptions.__reduce__(self) """
        pass
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x000001D1A899D150>'
    __slots__ = ()
