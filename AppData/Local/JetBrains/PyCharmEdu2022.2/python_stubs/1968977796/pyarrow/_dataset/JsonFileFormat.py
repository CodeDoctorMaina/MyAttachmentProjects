...
class JsonFileFormat(FileFormat):
    """
    JsonFileFormat(default_fragment_scan_options=None, ParseOptions parse_options=None, ReadOptions read_options=None)
    ...
    """
    def equals(self, JsonFileFormat_other): # real signature unknown; restored from __doc__
        """
        JsonFileFormat.equals(self, JsonFileFormat other)
    ...
    def __init__(self, default_fragment_scan_options=None, ParseOptions_parse_options=None, ReadOptions_read_options=None): # real signature unknown; restored from __doc__
        pass
    ...
    def __reduce__(self): # real signature unknown; restored from __doc__
        """ JsonFileFormat.__reduce__(self) """
        pass
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x000001D1A899D0F0>'
    __slots__ = ()
