...
class _ScanNodeOptions(__pyarrow__acero.ExecNodeOptions):
    # no doc
    def _set_options(self, Dataset_dataset, dict_scan_options): # real signature unknown; restored from __doc__
        """ _ScanNodeOptions._set_options(self, Dataset dataset, dict scan_options) """
        pass
    ...
    def __reduce__(self, *args, **kwargs): # real signature unknown
        """ _ScanNodeOptions.__reduce_cython__(self) """
        pass

    def __setstate__(self, *args, **kwargs): # real signature unknown
        """ _ScanNodeOptions.__setstate_cython__(self, __pyx_state) """
        pass

    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x000001D1A899D510>'
