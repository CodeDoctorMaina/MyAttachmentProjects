...
class Time64Type(DataType):
    ...
    """
    def __init__(self, time64, us=None): # real signature unknown; restored from __doc__
        pass
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x0000029E0467A7E0>'
