...
class VersionInfo(tuple):
    ...
    major = None # (!) real value is '<_collections._tuplegetter object at 0x0000029E0B058790>'
    minor = None # (!) real value is '<_collections._tuplegetter object at 0x0000029E0B058760>'
    patch = None # (!) real value is '<_collections._tuplegetter object at 0x0000029E0B058820>'
    _fields = (
        'major',
        'minor',
        'patch',
