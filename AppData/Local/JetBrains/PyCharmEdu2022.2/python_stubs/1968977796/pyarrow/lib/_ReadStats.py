...
class _ReadStats(tuple):
    ...
    num_dictionary_batches = None # (!) real value is '<_collections._tuplegetter object at 0x0000029E0B071FD0>'
    num_dictionary_deltas = None # (!) real value is '<_collections._tuplegetter object at 0x0000029E0B071F70>'
    num_messages = None # (!) real value is '<_collections._tuplegetter object at 0x0000029E0B071E20>'
    num_record_batches = None # (!) real value is '<_collections._tuplegetter object at 0x0000029E0B071EB0>'
    num_replaced_dictionaries = None # (!) real value is '<_collections._tuplegetter object at 0x0000029E0B071C40>'
    _fields = (
        'num_messages',
        'num_record_batches',
