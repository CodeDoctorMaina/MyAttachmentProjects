...
class RuntimeInfo(tuple):
    ...
    detected_simd_level = None # (!) real value is '<_collections._tuplegetter object at 0x0000029E0B058EE0>'
    simd_level = None # (!) real value is '<_collections._tuplegetter object at 0x0000029E0B058F10>'
    _fields = (
        'simd_level',
        'detected_simd_level',
    )
