...
class DictionaryScalar(Scalar):
    ...
    def _reconstruct(self, type, is_valid, index, dictionary): # real signature unknown; restored from __doc__
        """ DictionaryScalar._reconstruct(type, is_valid, index, dictionary) """
        pass
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x0000029E046F7F90>'
