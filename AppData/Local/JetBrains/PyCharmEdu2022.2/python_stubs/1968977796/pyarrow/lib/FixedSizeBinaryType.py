...
class FixedSizeBinaryType(DataType):
    ...
    """
    def __init__(self, fixed_size_binary, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
        pass
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x0000029E0467A8A0>'
