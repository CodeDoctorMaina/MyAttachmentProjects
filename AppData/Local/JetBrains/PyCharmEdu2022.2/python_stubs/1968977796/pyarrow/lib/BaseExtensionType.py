...
class BaseExtensionType(DataType):
    ...
    def __arrow_ext_class__(self): # real signature unknown; restored from __doc__
        """
        BaseExtensionType.__arrow_ext_class__(self)
    ...
    def __arrow_ext_scalar_class__(self): # real signature unknown; restored from __doc__
        """
        BaseExtensionType.__arrow_ext_scalar_class__(self)
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x0000029E0467AA20>'
