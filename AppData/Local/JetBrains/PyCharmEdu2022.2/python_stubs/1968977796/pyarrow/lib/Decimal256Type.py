...
class Decimal256Type(FixedSizeBinaryType):
    ...
    """
    def __init__(self, decimal256, *args, **kwargs): # real signature unknown; NOTE: unreliably restored from __doc__ 
        pass
    ...
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x0000029E0467A960>'
