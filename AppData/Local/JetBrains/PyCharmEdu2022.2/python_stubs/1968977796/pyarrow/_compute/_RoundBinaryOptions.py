...
class _RoundBinaryOptions(FunctionOptions):
    # no doc
    def _set_options(self, round_mode): # real signature unknown; restored from __doc__
        """ _RoundBinaryOptions._set_options(self, round_mode) """
        pass
    ...
    def __reduce__(self, *args, **kwargs): # real signature unknown
        """ _RoundBinaryOptions.__reduce_cython__(self) """
        pass

    def __setstate__(self, *args, **kwargs): # real signature unknown
        """ _RoundBinaryOptions.__setstate_cython__(self, __pyx_state) """
        pass

    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x000001FEE4123360>'
