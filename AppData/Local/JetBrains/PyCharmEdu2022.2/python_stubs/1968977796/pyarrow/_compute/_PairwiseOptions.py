...
class _PairwiseOptions(FunctionOptions):
    # no doc
    def _set_options(self, period): # real signature unknown; restored from __doc__
        """ _PairwiseOptions._set_options(self, period) """
        pass
    ...
    def __reduce__(self, *args, **kwargs): # real signature unknown
        """ _PairwiseOptions.__reduce_cython__(self) """
        pass

    def __setstate__(self, *args, **kwargs): # real signature unknown
        """ _PairwiseOptions.__setstate_cython__(self, __pyx_state) """
        pass

    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x000001FEE412E0C0>'
