...
class _RunEndEncodeOptions(FunctionOptions):
    # no doc
    def _set_options(self, run_end_type): # real signature unknown; restored from __doc__
        """ _RunEndEncodeOptions._set_options(self, run_end_type) """
        pass
    ...
    def __reduce__(self, *args, **kwargs): # real signature unknown
        """ _RunEndEncodeOptions.__reduce_cython__(self) """
        pass

    def __setstate__(self, *args, **kwargs): # real signature unknown
        """ _RunEndEncodeOptions.__setstate_cython__(self, __pyx_state) """
        pass

    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x000001FEE41238A0>'
