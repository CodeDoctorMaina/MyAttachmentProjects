...
class RegisterUdf(__pyarrow_lib._Weakrefable):
    # no doc
    ...
    def __reduce__(self, *args, **kwargs): # real signature unknown
        """ RegisterUdf.__reduce_cython__(self) """
        pass

    def __setstate__(self, *args, **kwargs): # real signature unknown
        """ RegisterUdf.__setstate_cython__(self, __pyx_state) """
        pass

    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x000001FEE412E3C0>'
