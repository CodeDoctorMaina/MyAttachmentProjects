...
class _CertKeyPair(tuple):
    ...
    cert = None # (!) real value is '<_collections._tuplegetter object at 0x00000262C58CFBE0>'
    key = None # (!) real value is '<_collections._tuplegetter object at 0x00000262C58CFD60>'
    _fields = (
        'cert',
        'key',
    )
