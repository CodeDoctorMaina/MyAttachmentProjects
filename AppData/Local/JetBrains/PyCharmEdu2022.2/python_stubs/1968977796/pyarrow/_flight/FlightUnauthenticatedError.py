...
class FlightUnauthenticatedError(FlightError, __pyarrow_lib.ArrowException):
    ...
    __dict__ = None # (!) real value is "mappingproxy({'__new__': <built-in method __new__ of type object at 0x00007FFE09B395F0>, '__reduce_cython__': <method '__reduce_cython__' of 'pyarrow._flight.FlightUnauthenticatedError' objects>, '__setstate_cython__': <method '__setstate_cython__' of 'pyarrow._flight.FlightUnauthenticatedError' objects>, '__dict__': <attribute '__dict__' of 'pyarrow._flight.FlightUnauthenticatedError' objects>, '__doc__': 'The client is not authenticated.', '__pyx_vtable__': <capsule object NULL at 0x00000262C58CFEA0>})"
    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x00000262C58CFEA0>'
