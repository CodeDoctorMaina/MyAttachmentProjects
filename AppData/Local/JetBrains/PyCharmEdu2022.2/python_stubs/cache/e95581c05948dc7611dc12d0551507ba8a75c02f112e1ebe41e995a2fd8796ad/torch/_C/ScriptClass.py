...
class ScriptClass(__pybind11_builtins.pybind11_object):
    ...
    def __getattr__(self, arg0): # real signature unknown; restored from __doc__
        """ __getattr__(self: torch._C.ScriptClass, arg0: str) -> torch._C.ScriptClassFunction """
        pass
