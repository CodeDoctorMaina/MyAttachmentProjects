...
class _ShapeComputeGraphMapping(__pybind11_builtins.pybind11_object):
    # no doc
    def graph_output_to_symbolic_shape_dim(self): # real signature unknown; restored from __doc__
        """ graph_output_to_symbolic_shape_dim(self: torch._C._ShapeComputeGraphMapping) -> Dict[torch._C.Value, int] """
        return {}

    def partial_eval_shape_graph(self): # real signature unknown; restored from __doc__
