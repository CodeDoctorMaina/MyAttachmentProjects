...
class RunEndEncodedType(DataType):
    ...
    def __reduce__(self): # real signature unknown; restored from __doc__
        """ RunEndEncodedType.__reduce__(self) """
        pass

    run_end_type = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    value_type = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default


    __pyx_vtable__ = None # (!) real value is '<capsule object NULL at 0x0000029E0467A9C0>'
