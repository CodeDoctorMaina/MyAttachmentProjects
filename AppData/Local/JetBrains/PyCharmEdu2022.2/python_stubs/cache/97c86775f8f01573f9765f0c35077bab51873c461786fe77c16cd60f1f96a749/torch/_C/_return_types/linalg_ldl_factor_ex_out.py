...
class linalg_ldl_factor_ex_out(tuple):
    # no doc
    ...
    LD = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default

    pivots = property(lambda self: object(), lambda self, v: None, lambda self: None)  # default
